			...
			else
			{
				...
				do
				{
					...
					$this->template->assign_block_vars('toppostrow', [
						...
						'POST_REPUT'				=> $this->gfksx_helper->to_rating($row['post_thanks'], $max_post_thanks),
			...
			else
			{
				...
				do
				{
					...
					$this->template->assign_block_vars('toptopicrow', [
						...
						'TOPIC_REPUT'				=> $this->gfksx_helper->to_rating($row['topic_thanks'], $max_topic_thanks),
				...
				do
				{
					if (!empty($row['forum_id']))
					{
						...
						$this->template->assign_block_vars('topforumrow', [
							...
							'FORUM_REPUT'				=> $this->gfksx_helper->to_rating($row['forum_thanks'], $max_forum_thanks),

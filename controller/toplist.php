			...
			else
			{
				...
				do
				{
					...
					$this->template->assign_block_vars('toppostrow', [
						...
						'POST_REPUT'				=> round($this->gfksx_helper->ease_out_exponential($row['post_thanks'] / ($max_post_thanks / 100)), (int) $this->config['thanks_number_digits']) . '%',
			...
			else
			{
				...
				do
				{
					...
					$this->template->assign_block_vars('toptopicrow', [
						...
						'TOPIC_REPUT'				=> round($this->gfksx_helper->ease_out_exponential($row['topic_thanks'] / ($max_topic_thanks / 100)), (int) $this->config['thanks_number_digits']) . '%',
				...
				do
				{
					if (!empty($row['forum_id']))
					{
						...
						$this->template->assign_block_vars('topforumrow', [
							...
							'FORUM_REPUT'				=> round($this->gfksx_helper->ease_out_exponential($row['forum_thanks'] / ($max_forum_thanks / 100)), (int) $this->config['thanks_number_digits']) . '%',

...
$lang = array_merge($lang, array(
	...
	'ACP_THANKS_REPUT_SETTINGS_EXPLAIN'	=> 'Setzen Sie die Standardeinstellungen für die Bewertung von Beiträgen, Themen und Foren, für die Erweiterung "Danksagungen für Beiträge".<br />Der betreffende Typ (Beitrag, Thema, Forum) mit der höchsten Anzahl an Danksagungen erhält eine 100% Bewertung.',
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN'	=> 'Forenbewertungen in einer Spalte anzeigen',
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Falls aktiviert, wird die Forenbewertung in einer Spalte in der Forenliste angezeigt.<br />Hinweis: Diese Option wird nur für den Style "prosilver" aktiviert, wenn die Forenbewertungen angezeigt werden sollen.',
	...
	'THANKS_NUMBER_DIGITS_EXPLAIN'		=> 'Setzen Sie die Anzahl an Nachkommastellen bei Bewertungen.',
	'THANKS_NUMBER_ROW_REPUT'			=> 'Anzahl der Zeilen in der Bewertungstopliste',
	'THANKS_NUMBER_ROW_REPUT_EXPLAIN'	=> 'Setzen Sie die Anzahl der Zeilen, die in den Beitrags-, Themen- und Forentoplisten angezeigt werden sollen.',
	...
	'THANKS_POSTLIST_VIEW_EXPLAIN'		=> 'Falls aktiviert, wird eine Liste der Benutzer, die sich beim Autor bedankt haben angezeigt.<br/>Beachten Sie, dass diese Option nur wirksam wird, wenn der Administrator die Berechtigung aktiviert hat, sich für einen Beitrag im Forum zu bedanken.',
	...
	'THANKS_TOPIC_REPUT_VIEW_COLUMN'	=> 'Themenbewertung in einer Spalte anzeigen',
	'THANKS_TOPIC_REPUT_VIEW_COLUMN_EXPLAIN' => 'Falls aktiviert, wird die Themenbewertung in einer Spalte in der Forenliste angezeigt.<br />Hinweis: Diese Option wird nur für den Style "prosilver" aktiviert, wenn die Themenbewertungen angezeigt werden sollen.',
	...
	'REFRESH_THANKS_CONFIRM'			=> 'Möchten Sie wirklich alle Danksagungszähler aktualisieren?',
	'TRUNCATE_THANKS_CONFIRM'			=> 'Möchten Sie wirklich alle Danksagungen löschen?',

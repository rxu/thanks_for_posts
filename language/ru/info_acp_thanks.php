...
$lang = array_merge($lang, [
	...
	'THANKS_AJAX_ENABLE'				=> 'Использовать Ajax',
	'THANKS_AJAX_ENABLE_EXPLAIN'		=> 'Если включено, отправка и удаление благодарностей будет осуществляться без перезагрузки страницы.',

...
$lang = array_merge($lang, array(
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Si cette option est activée, le classement du forum sera affiché dans une colonne dans la liste des forums. <br /> Note : cette option sera uniquement effective pour le style prosilver et si l’option ci-dessus est activée.',
	...
	'THANKS_FORUM_REPUT_VIEW_EXPLAIN'	=> 'Si cette option est activée, le classement du forum sera affiché dans la liste des forums.',
	...
	'THANKS_REPUT_LEVEL'				=> 'Nombre d’images dans une échelle graphique',
	...
	'THANKS_TOPIC_REPUT_VIEW_COLUMN_EXPLAIN' => 'Si cette option est activée, le classement du sujet sera affiché dans une colonne lorsque l’on visualise un forum. <br /> Note : cette option sera uniquement effective pour le style prosilver et si l’option ci-dessus est activée.',
	'THANKS_TOPIC_REPUT_VIEW_EXPLAIN'	=> 'Si cette option est activée, le classement du forum sera affiché lorsque l’on visualise un forum.',
	'TRUNCATE'							=> 'Effacer',

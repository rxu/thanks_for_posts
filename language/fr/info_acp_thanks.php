...
$lang = array_merge($lang, array(
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Si cette option est activée, le classement des forums est affiché dans une colonne dans la liste des forums.<br /><strong>Merci de noter que cette option est compatible uniquement avec le style « prosilver » et si l’option ci-dessus est activée.</strong>',
	...
	'THANKS_TOPIC_REPUT_VIEW_COLUMN_EXPLAIN' => 'Si cette option est activée, le classement des sujets est affiché dans une colonne lorsque l’on visualise un forum.<br /><strong>Merci de noter que cette option est compatible uniquement avec le style « prosilver » et si l’option ci-dessus est activée.</strong>',

...
$lang = array_merge($lang, array(
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN'	=> 'Mostrar a classificação dos fóruns numa coluna',
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Se ativado, a classificação dos fóruns será mostrada numa coluna na lista de fóruns. <br /> Nota: Esta opção só será eficaz em estilos Prosilver se a opção anterior estiver ativada.',
	...
	'THANKS_NUMBER_POST_EXPLAIN'		=> 'Máximo de agradecimentos a serem listados. <br /> <strong> Valores superiores a 250 podem tornar o sistema mais lento.</strong>',
	...
	'THANKS_REPUT_IMAGE_EXPLAIN'		=> 'O endereço da diretoria da imagem para a escala gráfica, relativamente à diretoria do phpBB.',
	...
	'THANKS_REPUT_IMAGE_BACK_EXPLAIN'	=> 'O endereço da diretoria da imagem para a escala gráfica, relativamente à diretoria do phpBB.',
	...
	'THANKS_TOPIC_REPUT_VIEW_COLUMN'	=> 'Mostrar a classificação dos Tópicos numa coluna',
	'THANKS_TOPIC_REPUT_VIEW_COLUMN_EXPLAIN' => 'Se ativado, a classificação dos Tópicos será exibida numa coluna ao ver os fóruns. <br /> Nota: esta opção só será eficaz em estilos prosilver e se a opção anterior estiver ativada.',
	...
	'TRUNCATE_THANKS_EXPLAIN'			=> 'TSe avançar com esta ação, os contadores de agradecimentos serão limpos (apaga todos os agradecimentos)',

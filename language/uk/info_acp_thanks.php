...
$lang = array_merge($lang, array(
	'acl_f_thanks' 						=> array('lang' => 'Може дякувати за повідомлення', 'cat' => 'misc'),
	'acl_m_thanks' 						=> array('lang' => 'Може очищати список подяк', 'cat' => 'misc'),
	'acl_u_viewthanks' 					=> array('lang' => 'Може переглядати лист всіх подяк', 'cat' => 'misc'),
	'acl_u_viewtoplist'					=> array('lang' => 'Може переглядати топ лист', 'cat' => 'misc'),
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN'	=> 'Відображення рейтингу для форумів в колонці',
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Якщо включено, рейтинг форуму буде відображатися в окремій колонці. <br /> Примітка: ця опція ефективна тільки для стилю prosilver і тільки при включенні опції вище.',
	...
	'THANKS_REPUT_IMAGE_DEFAULT_EXPLAIN' => 'Тут ви можете бачити саме зображення і шлях до файлу зображення. Розміри зображень 15х15 пікселів. <br />Ви можете намалювати власні зображення - основне і фонове, для цього можна використовувати файл reput_star_.psd в папці contrib. <strong>Висота і ширина зображення повинні бути однаковими для коректної побудови графічної шкали.</strong>',

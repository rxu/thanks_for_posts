...
$lang = array_merge($lang, array(
	...
	'THANKS_NUMBER_EXPLAIN'				=> 'Número máximo de gratitud que aparecera en el perfil.<br /> <strong>Recuerde que el consumo se notará si este valor se establece en más de 250.</strong>',
	...
	'THANKS_NUMBER_POST_EXPLAIN'		=> 'Número máximo de gracias mostrado cuando se ve un tema.<br /> <strong>Recuerde que la carga del servidor se notará si este valor se establece en más de 250.</strong>',
	...
	'THANKS_POST_REPUT_VIEW_EXPLAIN'	=> 'Si está activado, se mostrará el valor de clasificación para los mensajes al visualizar un tema',
	...
	'THANKS_PROFILELIST_VIEW_EXPLAIN'	=> 'Si esta opción está activada, se completa información de agradecimientos, incluyendo el número de agradecimientos y se mostrará cuando un usuario ha recibido agradecimientos.',
	...
	'THANKS_REPUT_IMAGE_BACK_NOEXIST'	=> 'La imagen de fondo a escala grafica no existe',
	...
	'TRUNCATE_THANKS_EXPLAIN'			=> 'Este procedimiento limpia los contadores de gracias (elimina todos las gracias publicadas). <br /> ¡La acción no es reversible!',

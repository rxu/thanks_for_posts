...
$lang = array_merge($lang, array(
	...
	'ACP_THANKS'						=> 'Gracias por los Mensajes',
	...
	'ACP_THANKS_REPUT_SETTINGS_EXPLAIN'	=> 'Aquí se puede establecer la configuración predeterminada para la valoración de mensajes, los temas y foros, basado en el sistema de agradecimiento.<br />Asunto (correo, temas y foros), que cuenta con el mayor número total de agradecimiento, se toma como calificación del 100%.',
	'ACP_THANKS_SETTINGS'				=> 'Configuración de gracias',
	'ACP_THANKS_SETTINGS_EXPLAIN'		=> 'Aqui puede ajustar valores personalziados para Gracias por los Mensajes.',
	...
	'LOG_CONFIG_THANKS'					=> 'Configuración de Gracias por los Mensajes actualizada',
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN'	=> 'Mostrar la calificación de los foros en colummnas.',
	...
	'THANKS_GLOBAL_POST_EXPLAIN'		=> 'Si está activado, el agradecimiento en Anuncio Global estará activado.',
	...
	'THANKS_NUMBER_EXPLAIN'				=> 'Número máximo de agradecimientos que aparecerán en el perfil.<br /><strong>Recuerde que el consumo se notará si este valor se establece en más de 250.</strong>',
	...
	'THANKS_NUMBER_POST'				=> 'Número de agradecimientos en la lista en los mensajes',
	'THANKS_NUMBER_POST_EXPLAIN'		=> 'Número máximo de agradecimientos mostrado cuando se ve un tema.<br /><strong>Recuerde que la carga del servidor se notará si este valor se establece en más de 250.</strong>',
	...
	'THANKS_POSTLIST_VIEW'				=> 'Lista de agradecimiento en el mensaje',
	...
	'THANKS_PROFILELIST_VIEW'			=> 'Lista de agradecimiento en el perfil',
	'THANKS_PROFILELIST_VIEW_EXPLAIN'	=> 'Si esta opción está activada, completa información de agradecimiento, incluyendo el número de agradecimiento y cuando un usuario que ha recibido agradecimientos, serán mostrados.',
	'THANKS_REFRESH'					=> 'Actualizar contadores de agradecimientos',
	'THANKS_REFRESH_EXPLAIN'			=> 'Aquí puede actualizar los contadores de agradecimientos después de la eliminación de mensajes / temas / usuarios. Esto puede tomar algún tiempo.',
	'THANKS_REFRESH_MSG'				=> 'El caché de actualizaciones puede tardar unos minutos. Todas las entradas incorrectas de agradecimientos sera borradas!<br />¡Esta acción no es reversible!',
	...
	'THANKS_TIME_VIEW'					=> 'Fecha de los agradecimientos',
	'THANKS_TIME_VIEW_EXPLAIN'			=> 'Si se activa, en el mensaje se mostrará la fecha de los agradecimientos',
	...
	'TRUNCATE'							=> 'Limpiar',
	'TRUNCATE_THANKS'					=> 'Limpiar la lista de agradecimientos',
	'TRUNCATE_THANKS_EXPLAIN'			=> 'Este procedimiento limpia los conadores de agradecimientos (elimina todos los agradecimientos publicados).<br />¡La acción no es reversible!',
	'TRUNCATE_THANKS_MSG'				=> 'Contadores de agradecimientos limpiados.',
	'REFRESH_THANKS_CONFIRM'			=> '¿Realmente desea actualizar los contadores de agradecimientos?',
	'TRUNCATE_THANKS_CONFIRM'			=> '¿Realmente desea limpiar el contador de agradecimientos?',
